...
class Util3dTpl(object):
    ...
    def __getitem__(self, k):
        return Util2dTpl(self.chararray[k], self.u3d.name_base[k] + str(k + 1),
                         self.multipliers[k], self.indexed_params)
